...
public class SwerveDriveIOReal implements SwerveDriveIO {
    ...
    public void setModuleStates(SwerveModuleState[] states, boolean force) {
        ...
        frontLeft.setTargetState(states[0], force);
        frontRight.setTargetState(states[1], force);
        backLeft.setTargetState(states[2], force);
        backRight.setTargetState(states[3], force);
    }
